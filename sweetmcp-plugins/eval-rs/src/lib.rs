...
pub(crate) fn describe() -> Result<ListToolsResult, Error> {
    Ok(ListToolsResult{
        tools: vec![
            ToolDescription {
                name: "eval_rust".into(),
                description: "Execute Rust code snippets in a sandboxed environment. Use this tool when you need to:
- Test Rust code patterns and idioms
- Demonstrate Rust's ownership and borrowing concepts
- Perform type-safe calculations and transformations
- Validate Rust syntax and expressions
- Explore Rust standard library functionality
Perfect for Rust education, code testing, and safe experimentation. Note: Currently incorrectly implemented with Python - needs proper Rust evaluation engine.".into(),
                input_schema: json!({
                    "type": "object",
                    "properties": {
                        "code": {
                            "type": "string",
                            "description": "The Rust code to evaluate",
                        },
                    },
                    "required": ["code"],
                })
