...
impl<T: Entity + 'static> Dao<T> {
    ...
    /// Create a new entity
    pub fn create(&self, entity: &mut <Self as BaseDao>::Entity) -> crate::types::AsyncTask<<Self as BaseDao>::Entity> {
        let client = self.client.clone();
    ...
    /// Update an entity
    pub fn update(&self, entity: &<Self as BaseDao>::Entity) -> crate::types::AsyncTask<Option<<Self as BaseDao>::Entity>> {
        let client = self.client.clone();
...
impl<T: Entity + 'static> BaseDao for Dao<T> {
    type Entity = T;
    /// Create a new entity
    fn create(&self, entity: &mut <Self as BaseDao>::Entity) -> crate::types::AsyncTask<<Self as BaseDao>::Entity> {
        let client = self.client.clone();
        let mut entity_clone = entity.clone();
        if entity_clone.id().is_none() {
            let generated_id = T::generate_id();
    ...
    /// Update an entity
    fn update(&self, entity: &<Self as BaseDao>::Entity) -> crate::types::AsyncTask<Option<<Self as BaseDao>::Entity>> {
        let client = self.client.clone();
        let entity = entity.clone();
        crate::types::AsyncTask::from_future(async move {
            match entity.id() {
