...
impl Config {
    ...
    pub fn from_env() -> Result<Self> {
        ...
        let tcp_bind = env::var("SWEETMCP_TCP_BIND")
            .unwrap_or_else(|_| "0.0.0.0:8443".to_string());
        
        let uds_path = env::var("SWEETMCP_UDS_PATH")
            .unwrap_or_else(|_| "/run/sugora.sock".to_string());
        ...
        let metrics_bind = env::var("SWEETMCP_METRICS_BIND")
            .unwrap_or_else(|_| "127.0.0.1:9090".to_string());
        
        let jwt_expiry_str = env::var("SWEETMCP_JWT_EXPIRY")
            .unwrap_or_else(|_| "1h".to_string());
        let jwt_expiry = parse_duration(&jwt_expiry_str)
            .context("Invalid SWEETMCP_JWT_EXPIRY format")?;
        
        let health_check_interval_str = env::var("SWEETMCP_HEALTH_CHECK_INTERVAL")
        ...
        let request_timeout_str = env::var("SWEETMCP_REQUEST_TIMEOUT")
