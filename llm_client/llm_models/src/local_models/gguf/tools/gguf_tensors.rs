...
impl TensorInfo {
    pub fn parameters(&self) -> usize {
        self.shape.iter().product() // Remove copied()
    }
    pub fn size(&self) -> usize {
        self.parameters() * self.ggml_dtype.type_size() // Remove cast
            / self.ggml_dtype.block_size() // Remove cast
    }
}
