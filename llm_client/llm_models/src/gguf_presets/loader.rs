...
use crate::{local_models::{gguf::load_chat_template, hf_loader::HuggingFaceLoader, LocalLlmModel, metadata::LocalLlmMetadata}, LlmChatTemplate};
...
#[derive(Clone, Default)] // Use derive for Default
